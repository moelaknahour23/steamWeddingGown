...
>(function MultiStepFormStep({ children, asChild, ...props }, ref) {
	...
	// Make sure the ref is passed correctly to the Cmp
	return (
		//@ts-ignore
		<Cmp ref={ref} {...props}>
...
function AnimatedStep({ isActive, direction, children, index, currentIndex }: React.PropsWithChildren<AnimatedStepProps>) {
